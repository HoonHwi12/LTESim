...
BENCHROOT=/home/hyunji/LSTM/hj_lstm
DIR=( new_ue_50_BE)
...
do
    ...
    do
        ...
        do
            ...
            ./build/main $files $iter_0 $BENCHROOT/"BE"/"output_2"/train $epoch_0 $iter_1 > $BENCHROOT/"BE"/"output_2"/"output"$iter_0"_"$epoch_0".txt"
