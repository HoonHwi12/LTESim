...
private:
	...
	ENodeB::DLSchedulerType FetchScheduler(int *fd);
	...
	void FormUESummaryMessage(ENodeB *eNB, std::string *target_string);

	void ConnectCQIFifo(int *fd);
	void SendCQISummary(int *fd);
	void FormCQIMessage(ENodeB *eNB, std::string *target_string);
