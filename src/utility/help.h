...
static void Help (void)
{
	...
	std::cout <<
			...
			"\n"
			"\t ./LTE-Sim SingleCellWithIMixedApps nbCells radius nbUE nbVideo nbCBR sched_type frame_struct speed maxDelay videoBitRate seed(optional)"
			"\n\t\t --> ./LTE-Sim SingleCellWithIMixedApps 1 1 2 1 1 1 1 0 0.1 128  ~ 2 UEs, 1 video 1 CBR"
			"\n"
