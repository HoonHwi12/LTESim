...
void
ENodeB::my_scheduler_print(void){
  switch (my_scheduler)
    {
      case ENodeB::DLScheduler_TYPE_PROPORTIONAL_FAIR:
        printf("ENodeB id# %d, scheduler is PF_Fair\n", GetIDNetworkNode());
      break;
      case ENodeB::DLScheduler_TYPE_FLS:
        printf("ENodeB id# %d, scheduler is FLS\n", GetIDNetworkNode());
      break;
      case ENodeB::DLScheduler_TYPE_EXP:
        printf("ENodeB id# %d, scheduler is EXP\n", GetIDNetworkNode());
      break;
      case ENodeB::DLScheduler_TYPE_MLWDF:
        printf("ENodeB id# %d, scheduler is MLWDF\n", GetIDNetworkNode());
      break;
      case ENodeB::DLScheduler_EXP_RULE:
        printf("ENodeB id# %d, scheduler is EXP_RULE\n", GetIDNetworkNode());
      break;
      case ENodeB::DLScheduler_LOG_RULE:
        printf("ENodeB id# %d, scheduler is LOG_RULE\n", GetIDNetworkNode());
      break;
      default:
        printf("ENodeB id# %d, scheduler is donno dont care\n", GetIDNetworkNode());
      break;
    }
